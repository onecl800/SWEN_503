 ...
 */
Blockly.Blocks['variables_get'].postInit = function() {
 ...
 */
Blockly.Blocks['variables_get'].typeOf = function(name){
 ...
 * @this Blockly.Block
 */
Blockly.Blocks['variables_get'].changeType = function(name, type) {
 ...
 */
Blockly.Blocks['variables_get'].setType = function(type, force) {
 ...
 */
Blockly.Blocks['variables_get'].typeChangedHandler = function(type){
 ...
 */
Blockly.Blocks['variables_get'].nameChangedHandler = function(newName){
    var self = this.sourceBlock_;
 ...
 * @param {string} type The new type for the block
 */
Blockly.Blocks['variables_set'].setType = function(type) {
    this.setFieldValue(type, 'TYPE');
    this.getInput('VALUE').setCheck(type);
};
Blockly.Blocks['variables_set'].renameVar = Blockly.Blocks['variables_get'].renameVar;
Blockly.Blocks['variables_set'].getVars = Blockly.Blocks['variables_get'].getVars;
Blockly.Blocks['variables_set'].postInit = Blockly.Blocks['variables_get'].postInit;
Blockly.Blocks['variables_set'].typeOf = Blockly.Blocks['variables_get'].typeOf;
Blockly.Blocks['variables_set'].changeType = Blockly.Blocks['variables_get'].changeType;
Blockly.Blocks['variables_set'].customContextMenu = Blockly.Blocks['variables_get'].customContextMenu;
Blockly.Blocks['variables_set'].typeChangedHandler = Blockly.Blocks['variables_get'].typeChangedHandler;
Blockly.Blocks['variables_set'].nameChangedHandler = Blockly.Blocks['variables_get'].nameChangedHandler;
